...
To rename the project from "my-app" to your desired names, run the provided script with one
arguments: the kebab-case replacement for "my-app". For example:

```bash
./rename_script.sh my-wiki
```

This will update all file contents and rename files/directories accordingly. Run it from the project
root, and commit changes afterward. Test in a copy first to avoid issues.
